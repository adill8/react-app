    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:flex lg:items-start items-center justify-center">
          {/* Image section */}
          <div className="lg:w-1/2 w-full mb-8 flex justify-center bg-amber-50">
            <img
              alt="ecommerce"
              className="object-cover rounded"
              src="/images/Sofa-set-2.png"
            />
          </div>

          {/* Product Detail */}
          <div className="lg:w-1/2 w-full lg:pl-10">
            <h1 className="text-gray-900 text-5xl mb-3">
              Asgaard sofa
            </h1>
            <p className="text-gray-500 text-2xl mb-3">Rs. 250,000.00</p>
          ...
          highs for a sound.
            ...
            {/* Size */}
              <div className="mr-4">
                ...
                <button className="border px-2 py-1 rounded text-sm bg-yellow-600 text-white">L</button>
                <button className="border px-2 py-1 rounded text-sm font-semibold bg-amber-50">XL</button>
                <button className="border px-2 py-1 rounded text-sm font-semibold bg-amber-50">XS</button>
                </div>
              </div>
